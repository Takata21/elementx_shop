        ...
        <div className="pt-4 px-3">
          <div className="d-flex flex-wrap align-items-start text-light pb-2">
            <div className="col-md-4 col-sm-12 col-xs-12 d-flex flex-column px-2 pb-4">
              <h5 className="fw-bold text-success text-center fs-6">
                ¿Qué es?
              </h5>
              <p className="text-secondary text-center lh-sm fs-7">
                <b>Elementx.Online</b> es una aplicación, que funciona como
                tienda virtual para la venta de productos y servicios que ofrece
                tanto la empresa, así como sus asociados.
              </p>
              <a
                name=""
                href=""
